...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins axi_vip_0/M_AXI] [get_bd_intf_pins ps8_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axi_bram_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_bram_0_bram_addr [get_bd_pins axi_bram_0/bram_addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net axi_bram_0_bram_en [get_bd_pins axi_bram_0/bram_en] [get_bd_pins blk_mem_gen_0/ena]
  connect_bd_net -net axi_bram_0_bram_wdata [get_bd_pins axi_bram_0/bram_wdata] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net axi_bram_0_bram_wen [get_bd_pins axi_bram_0/bram_wen] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins axi_bram_0/bram_rdata] [get_bd_pins blk_mem_gen_0/douta]
  connect_bd_net -net rst_ps8_0_100M_interconnect_aresetn [get_bd_pins axi_vip_0/aresetn] [get_bd_pins rst_ps8_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_bram_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ps8_0_axi_periph/S02_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins blk_mem_gen_0/regcea] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_0/s00_axi_aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins ps8_0_axi_periph/S02_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs axi_bram_0/S00_AXI/S00_AXI_reg] SEG_axi_bram_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_0/S00_AXI/S00_AXI_reg] SEG_axi_bram_0_S00_AXI_reg
